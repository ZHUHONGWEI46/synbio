...
export function researchHeaderArt(id) {
  ...
  if (row < 0) return '';
  return `<div class="research-header-art" aria-hidden="true" style="--art-row:${row * 25}%"><div class="research-art-sprite"></div><svg class="research-art-orbit" viewBox="0 0 700 180"><path d="M25 145 C190 175 455 5 675 70"/><circle r="3"><animateMotion dur="14s" repeatCount="indefinite" path="M25 145 C190 175 455 5 675 70"/></circle></svg><small>研究流程示意 · 非实验结果</small></div>`;
}
export function moduleGuide(id) {
  ...
  if (id === 'validation') return `<div class="validation-map">${feedbackDiagram()}<div><span class="route-caption">R0 → R1 → R2</span><h2>让实验反馈进入下一轮学习。</h2><p>正式资料已归档三轮实验与时间前向评估。同一 R2 测试集上，FCNN 的 Spearman 从 −0.040 变为 0.118；这一改善不能推广到所有模型。</p><a href="#wet-lab" data-project-topic="wet-lab">查看纯酶与全细胞验证 ↗</a></div></div>`;
