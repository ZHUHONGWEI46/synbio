...
archive = Path('/Users/zhuhongwei/Downloads/NJTech-SynCAR-2026-main (3).zip')
...
(destination / 'files.json').write_text(json.dumps(sorted(imported), ensure_ascii=False), encoding='utf-8')
